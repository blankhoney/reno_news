...
| V2.2 | Production Deploy, Secrets, and Off-Host Backup | In Progress | Only Caddy binds public ports, deploy/rollback contracts are documented, and backup/restore dry-runs are verifiable without secrets. |
