...
| V2.4 | MiniMax Model Integration and Evaluation Gate | In Progress | MiniMax M2.7 is behind the existing provider abstraction, all structured output passes schema validation or is quarantined, and a golden-set harness is available. |
