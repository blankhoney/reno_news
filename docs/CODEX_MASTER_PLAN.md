...
| V2.6 | Structured Source Expansion and Similarity Signals | Completed | GitHub and arXiv adapters enter the existing pipeline safely; GDELT and RSSHub stay constrained; PostgreSQL remains the search source of truth. |
