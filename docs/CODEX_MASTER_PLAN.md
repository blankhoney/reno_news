...
| V2.3 | Observability and Alerting | In Progress | `/metrics`, safe structured logs, trace ids, alert rules, and runbooks exist for service, queue, model, disk, and backup failures. |
